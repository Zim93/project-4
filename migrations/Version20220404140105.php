 ...
 */
final class Version20220404140105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE house ADD kitchen JSON DEFAULT NULL, ADD outside JSON DEFAULT NULL');
    }
