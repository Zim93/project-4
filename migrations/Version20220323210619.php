 ...
 */
final class Version20220323210619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP google_event_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE google_event_id google_event_id VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE reservation ADD google_event_id VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
