 ...
 */
final class Version20220329184335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3BAE0AA7B83297E7 ON event');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3BAE0AA7B83297E7 ON event (reservation_id)');
