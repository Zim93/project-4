 ...
 */
final class Version20220411000851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, house_id INT NOT NULL, reservation_id INT DEFAULT NULL, type TINYINT(1) NOT NULL, opened TINYINT(1) NOT NULL, INDEX IDX_BF5476CA6BB74515 (house_id), INDEX IDX_BF5476CAB83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
