 ...
 */
final class Version20220412004856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE house ADD strong_points JSON DEFAULT NULL');
    }
