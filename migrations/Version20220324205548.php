 ...
 */
final class Version20220324205548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE house ADD lat VARCHAR(255) NOT NULL, ADD lng VARCHAR(255) NOT NULL');
    }
