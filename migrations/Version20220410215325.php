 ...
 */
final class Version20220410215325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE house ADD breakfast_dispo TINYINT(1) NOT NULL, ADD arrival_time_max TIME NOT NULL');
    }
