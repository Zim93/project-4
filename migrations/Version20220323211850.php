 ...
 */
final class Version20220323211850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD start_at DATE NOT NULL, ADD end_at DATE NOT NULL, DROP google_event_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD google_event_id VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP start_at, DROP end_at');
